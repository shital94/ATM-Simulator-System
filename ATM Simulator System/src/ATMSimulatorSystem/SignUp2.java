...
public class SignUp2 extends JFrame implements ActionListener {
    ...
    SignUp2()
    {
       ...
       int w=z/y;
        ...
        String religion[]={"Hindu","Sikh","Christian,Brahmin","Muslim","Others"};
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            try
            {
               ...
               {
                   conn c1=new conn();
                   //for database query : we can follow the ordered which we put the fields into database same as followed it.
                   //otherwise proper table not showed on the screen.
